...
type StudentWithoutAddress = Omit<Student, 'addres'>
...
// Obs! Om du hellre vill använda interface istället för type går det bra att byta.// DIN UPPGIFT: Skapa en ny typ från den befintliga typen Student. Använd olika Utility Types för att lösa uppgifterna. / 3 poäng
